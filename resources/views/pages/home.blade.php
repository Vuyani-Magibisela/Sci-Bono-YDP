        ...
        <div class="container">
            ...
            <div class="toc-container">
                ...
                <div class="toc-unit active-course">
                    ...
                    <a href="UIUXCourse/UIUXCourseModules.html" class="toc-link">Start Learning</a>
                </div>
            ...
            <div class="footer-content">
                ...
                <div class="footer-links">
                    ...
                    <div class="footer-column">
                        <h4>Courses</h4>
                        <ul>
                            <li><a href="course-web-dev.html">Web Development</a></li>
                            <li><a href="course-programming.html">Programming</a></li>
                            <li><a href="course-iot.html">Internet of Things</a></li>
                            <li><a href="course-linux.html">Linux Essentials</a></li>
                        </ul>
                    </div>
                    <div class="footer-column">
                        <h4>Contact Info</h4>
